...
- Use `--diff-only` to omit the full annotated diff from the output and return only the comment summary. Useful when the diff is already in your context and you want to save tokens.
